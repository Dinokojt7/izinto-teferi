...
// In CartRepo - FIXED clearCart method
  Future<bool> clearCart() async {
    try {
      ...
      final keysToRemove = [
        AppConstants.NEW_CART_LIST, // Your main cart key
        AppConstants.CART_LIST, // Old cart key (if exists)
        AppConstants.CART_HISTORY_LIST, // History
      ];
